...
public class FluidTankTile extends FluidTank {
    ...
    public boolean canFillFluidType (FluidStack fluid) {
        ...
        if (ConfigurationHandler.handleTemperature && fluid != null && this.tile instanceof TileEntityModularTank && ((TileEntityModularTank) this.tile).getTier().isFlammable(this.tile.getWorld(), this.tile.getPos(), EnumFacing.UP) && fluid.getFluid().getTemperature() > ConfigurationHandler.maxFluidHeat)
            return false;
